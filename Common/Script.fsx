...
# 1 @"(6) F# let inline atr att v = Val.attrV  att (Val.fixit v).fsx"
...
# 1 @"(6) F# let inline storeVar'T storeName (varIRef_) =.fsx"
      [< Inline >]
...
# 1 @"(6) F# type RunNode(nodeName, clearNode bool) =.fsx"
...
# 1 @"(6) F# RunHtmlPlusFree.fsx"
        member        this.RunHtmlPlusFree node =
          ...
          |> this.RunHtml
# 1 @"(4) F# module FSharpStation =.fsx"
    [<JavaScript>]
    module FSharpStation =
    
# 1 @"(6) F# type CodeSnippetId = CodeSnippetId of System.Guid.fsx"
...
# 1 @"(6) F# currentCodeSnippetId.fsx"
