...
{
 "use strict";
 var Global,CIPHERPrototype,LoginForm,Model,Message,LoginUINext,CodeMirror,EditorRpc,TestFormModule,Button,FSharpStationNS,HtmlNode,Val,HelperType,HtmlNode$1,Template,Button$1,Input,Hoverable,TextArea,CodeMirror$1,SplitterBar,Grid,RunCode,EditorRpc$1,RunNode,FSharpStation,CodeSnippetId,CodeSnippet,Position,SC$1,WebServer,Client,WebServer_JsonDecoder,WebServer_Templates,WebServer_JsonEncoder,App,App$1,IntelliFactory,Runtime,WebSharper,List,Rop,Result,Wrap,CIPHERHtml,Remoting,AjaxRemotingProvider,Seq,UI,Next,Var,Doc,View,AttrModule,Concurrency,Val$1,Html,AttrProxy,PrintfHelpers,Input$1,Mouse,Strings,Arrays,Collections,FSharpSet,BalancedTree,Operators,Unchecked,Guid,Option,Json,Provider,Slice,Storage,ListModel;
 Global=window;
 ...
 Button$1=Template.Button=Template.Button||{};
 ...
 EditorRpc$1=RunCode.EditorRpc=RunCode.EditorRpc||{};
 ...
 SC$1=Global.StartupCode$WebServer$CodeEditor=Global.StartupCode$WebServer$CodeEditor||{};
 WebServer=CIPHERPrototype.WebServer=CIPHERPrototype.WebServer||{};
 Client=WebServer.Client=WebServer.Client||{};
 WebServer_JsonDecoder=Global.WebServer_JsonDecoder=Global.WebServer_JsonDecoder||{};
 WebServer_Templates=Global.WebServer_Templates=Global.WebServer_Templates||{};
 WebServer_JsonEncoder=Global.WebServer_JsonEncoder=Global.WebServer_JsonEncoder||{};
 ...
 Val$1=CIPHERPrototype&&CIPHERPrototype.Val;
 Html=Val$1&&Val$1.Html;
 ...
 Button=TestFormModule.Button=Runtime.Class({
  ...
  get_Render:function()
  {
   ...
   return Html.button([Html.type(this._type),Html["class"](this._class),Html.style(this.style),{
    $:5,
    $0:(a=View.Const(""),(a$1=Val$1.toView(this.disabled),AttrModule.DynamicPred("disabled",a$1,a)))
   },{
    $:5,
 ...
 TestFormModule.dynamicSection=function()
 {
  ...
  }).get_Render(),Html.someElt((a=[AttrProxy.Create("placeholder","F#:"),AttrProxy.Create("title","Add F# code and invoke with Eval F#"),AttrProxy.Create("spellcheck","false")],Doc.InputArea(a,freeFS))),Html.someElt((a$1=[AttrProxy.Create("placeholder","HTML:"),AttrProxy.Create("title","Enter HTML tags and text"),AttrProxy.Create("spellcheck","false")],Doc.InputArea(a$1,freeHtml))),Html.someElt((a$2=[AttrProxy.Create("placeholder","CSS:"),AttrProxy.Create("title","Test your CSS styles dynamically"),AttrProxy.Create("spellcheck","false")],Doc.InputArea(a$2,freeCSS))),Html.someElt((a$3=[AttrProxy.Create("placeholder","JavaScript:"),AttrProxy.Create("title","Add JS code and invoke with Eval JS"),AttrProxy.Create("spellcheck","false")],Doc.InputArea(a$3,freeJS))),Button.New$1("Eval JS").Style("vertical-align:top").OnClick(function()
  {
   ...
   $:4,
   $0:Val$1.tag(Doc.Verbatim,Val$1.map2((f=function($1,$2,$3)
   {
 ...
 Button$1=Template.Button=Runtime.Class({
  OnClick:function(f)
  {
   return Button$1.New(this._class,this._type,this.style,this.text,f,this.disabled,this.id);
  },
  Disabled:function(dis)
  {
   var d;
   d=Val.fixit(dis);
   return Button$1.New(this._class,this._type,this.style,this.text,this.onClick,d,this.id);
  },
  Text:function(txt)
  {
   var t;
   t=Val.fixit(txt);
   return Button$1.New(this._class,this._type,this.style,t,this.onClick,this.disabled,this.id);
  },
  Style:function(sty)
  {
   var s;
   s=Val.fixit(sty);
   return Button$1.New(this._class,this._type,s,this.text,this.onClick,this.disabled,this.id);
  },
  Type:function(typ)
  {
   var t;
   t=Val.fixit(typ);
   return Button$1.New(this._class,t,this.style,this.text,this.onClick,this.disabled,this.id);
  },
  Class:function(clas)
  {
   return Button$1.New(Val.fixit(clas),this._type,this.style,this.text,this.onClick,this.disabled,this.id);
  },
  Id:function(id)
  {
   return Button$1.New(this._class,this._type,this.style,this.text,this.onClick,this.disabled,id);
  },
  get_Render:function()
  {
 ...
 Button$1.New$1=function(txt)
 {
  return Button$1.New(Val.fixit("btn"),Val.fixit("button"),Val.fixit(""),Val.fixit(txt),function()
  {
   return function()
   {
    return null;
 ...
 Button$1.New=function(_class,_type,style,text,onClick,disabled,id)
 {
  return new Button$1({
   _class:_class,
   _type:_type,
 ...
 CodeMirror$1=Template.CodeMirror=Runtime.Class({
  ...
  OnChange:function(f)
  {
   return CodeMirror$1.New(this._class,this.id,this["var"],f);
  },
  SetVar:function(v)
  {
   return CodeMirror$1.New(this._class,this.id,v,this.onChange);
  },
  Id:function(id)
  {
   return CodeMirror$1.New(this._class,id,this["var"],this.onChange);
  },
  Class:function(clas)
  {
   return CodeMirror$1.New(Val.fixit(clas),this.id,this["var"],this.onChange);
  },
  get_Render:function()
  {
   var $this,a,a$1,a$2;
 ...
 {
  return CodeMirror$1.New(Val.fixit(""),"",_var,function()
  {
  });
 };
 CodeMirror$1.New=function(_class,id,_var,onChange)
 {
 ...
 EditorRpc$1.evaluate=function(callback,source)
 {
  var x;
  x=(new AjaxRemotingProvider.New()).Async("ZafirTranspiler:CIPHERPrototype.Editor.evaluate:-1485533303",[source]);
  EditorRpc$1.callRPC(x,callback);
 };
 EditorRpc$1.translate=function(callback,minified,source)
 {
  var x;
  x=(new AjaxRemotingProvider.New()).Async("ZafirTranspiler:CIPHERPrototype.Editor.translate:796244877",[source,minified]);
  EditorRpc$1.callRPC(x,callback);
 };
 EditorRpc$1.declarations=function(callback,line,col,source)
 {
  var x;
  x=(new AjaxRemotingProvider.New()).Async("ZafirTranspiler:CIPHERPrototype.Editor.declarations:-2117802712",[source,line,col]);
  EditorRpc$1.callRPC(x,callback);
 };
 EditorRpc$1.methods=function(callback,line,col,source)
 {
  var x;
  x=(new AjaxRemotingProvider.New()).Async("ZafirTranspiler:CIPHERPrototype.Editor.methods:-34435681",[source,line,col]);
  EditorRpc$1.callRPC(x,callback);
 };
 EditorRpc$1.checkSource=function(callback,source)
 {
  var x;
  x=(new AjaxRemotingProvider.New()).Async("ZafirTranspiler:CIPHERPrototype.Editor.checkSource:2013062947",[source]);
  EditorRpc$1.callRPC(x,callback);
 };
 EditorRpc$1.callRPC=function(asy,callback)
 {
 ...
 RunCode.compile=function(fThen,fFail,code)
 {
  ...
  (((Runtime.Curried3(EditorRpc$1.translate))(function($1)
  {
   return c($1[0],$1[1]);
  }))(false))(code);
 };
 ...
 FSharpStation.CodeEditor=function()
 {
  ...
  },a$6),contentVar)))))).Prefix(HtmlNode.htmlText("name:")).get_Render()).Content$1("content1",CodeMirror$1.New$2((v$1=FSharpStation.currentCodeSnippetId(),(view$1=Val.toView(Val.fixit(v$1)),(contentVar$1=Var.Create$1(null),(changingIRefO$1=[null],(a$7=contentVar$1.v,View.Sink(function(v$2)
  {
   var o,r;
   o=changingIRefO$1[0];
   o==null?void 0:(r=o.$0,!Unchecked.Equals(r.RVal(),v$2)?r.set_RVal(v$2):void 0);
  ...
  }).get_Render().AddChildren([HtmlNode.style1("height","100%")])).Content$1("content2",TextArea.New$2(FSharpStation.codeMsgs()).Placeholder("Output:").Title("Messages").get_Render()).Content$1("content3",TextArea.New$2(FSharpStation.codeJS()).Placeholder("Javascript:").Title("JavaScript code generated").get_Render()).Content$1("footer2",TextArea.New$2(FSharpStation.codeFS()).Placeholder("F# code:").Title("F# code assembled").get_Render()).Content$1("footer",HtmlNode.div([Button$1.New$1("Add code").Class("btn btn-xs").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
   FSharpStation.addCode();
  })).get_Render(),Button$1.New$1("<<").Class("btn btn-xs").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
   FSharpStation.indentCodeOut();
  })).Disabled(FSharpStation.noSelectionVal()).get_Render(),Button$1.New$1(">>").Class("btn btn-xs").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
   FSharpStation.indentCodeIn();
  })).Disabled(FSharpStation.noSelectionVal()).get_Render(),FSharpStation.loadFileElement().get_Render().AddChildren([HtmlNode.style("grid-column: 4/6")]),HtmlNode.span([]),Button$1.New$1("Evaluate F# (FSI)").Class("btn btn-xs").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
   FSharpStation.evaluateFS();
  })).Disabled(FSharpStation.noSelectionVal()).get_Render(),Button$1.New$1("Get F# code ==>").Class("btn btn-xs").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
   FSharpStation.getFSCode();
  })).Disabled(FSharpStation.noSelectionVal()).get_Render(),Button$1.New$1("Delete code").Class("btn btn-xs").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
   FSharpStation.deleteCode();
  })).Disabled(FSharpStation.noSelectionVal()).get_Render(),HtmlNode.span([]),HtmlNode.span([]),Button$1.New$1("Save as...").Class("btn            ").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
   FSharpStation.downloadFile();
  })).get_Render().AddChildren([HtmlNode.classIf("btn-primary",FSharpStation.dirty())]),HtmlNode.span([]),Button$1.New$1("Compile WebSharper").Class("btn btn-xs").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
   FSharpStation.justCompile();
  })).Disabled(FSharpStation.noSelectionVal()).get_Render(),Button$1.New$1("Run WebSharper in ...").Class("btn btn-xs").OnClick((Runtime.Curried3(FSharpStation.Do))(function()
  {
 ...
 {
  var x,x$1,obj,n,m;
  x=(x$1=Arrays.ofSeq((FSharpStation.codeSnippets())["var"].RVal()),(obj=((Provider.EncodeArray(WebServer_JsonEncoder.j))())(x$1),Global.JSON.stringify(obj)));
 ...
 FSharpStation.loadFile=function(e)
 {
  if(!FSharpStation.dirty().c?true:Global.confirm("Changes have not been saved, do you really want to load?"))
   FSharpStation.loadTextFile(e.getRootNode().firstChild.querySelector("#"+FSharpStation.fileInputElementId()),function(txt)
   {
    ...
    try
    {
     a=((Provider.DecodeArray(WebServer_JsonDecoder.j))())(Global.JSON.parse(txt));
 ...
 SC$1.$cctor=Runtime.Cctor(function()
 {
  ...
  SC$1.codeSnippetsStorage=Storage.LocalStorage("CodeSnippets",{
   Encode:WebServer_JsonEncoder.j(),
   Decode:WebServer_JsonDecoder.j()
  });
  ...
  (function(v$3)
  {
   ...
   v$4!==null?v$3.set_RVal((WebServer_JsonDecoder.j$1())(Global.JSON.parse(v$4))):void 0;
   return Val.sink(function(v$5)
   {
    Global.window.localStorage.setItem(s,Global.JSON.stringify((WebServer_JsonEncoder.j$1())(v$5)));
   },v$3);
  ...
  (function(v$3)
  {
   ...
   v$4!==null?v$3.set_RVal((WebServer_JsonDecoder.j$2())(Global.JSON.parse(v$4))):void 0;
   return Val.sink(function(v$5)
   {
    Global.window.localStorage.setItem(s$1,Global.JSON.stringify((WebServer_JsonEncoder.j$2())(v$5)));
   },v$3);
 ...
 WebServer_JsonDecoder.j$2=function()
 {
  return WebServer_JsonDecoder._v$2?WebServer_JsonDecoder._v$2:WebServer_JsonDecoder._v$2=(Provider.DecodeUnion(void 0,"$",[[0,[]],[1,[]],[2,[]],[3,[]]]))();
 };
 ...
 WebServer_JsonEncoder.j$1=function()
 {
  return WebServer_JsonEncoder._v$1?WebServer_JsonEncoder._v$1:WebServer_JsonEncoder._v$1=(Provider.EncodeUnion(void 0,"$",[[0,[["$0","Item",Provider.Id(),0]]]]))();
 };
 WebServer_JsonEncoder.j=function()
 {
  return WebServer_JsonEncoder._v?WebServer_JsonEncoder._v:WebServer_JsonEncoder._v=(Provider.EncodeRecord(CodeSnippet,[["name",Provider.Id(),0],["content",Provider.Id(),0],["parent",WebServer_JsonEncoder.j$1,1],["predecessors",Provider.EncodeList(WebServer_JsonEncoder.j$1),0],["companions",Provider.EncodeList(WebServer_JsonEncoder.j$1),0],["id",WebServer_JsonEncoder.j$1,0],["expanded",Provider.Id(),0]]))();
 };
 WebServer_JsonDecoder.j$1=function()
 {
  return WebServer_JsonDecoder._v$1?WebServer_JsonDecoder._v$1:WebServer_JsonDecoder._v$1=(Provider.DecodeUnion(void 0,"$",[[0,[["$0","Item",Provider.Id(),0]]]]))();
 };
 WebServer_JsonDecoder.j=function()
 {
  return WebServer_JsonDecoder._v?WebServer_JsonDecoder._v:WebServer_JsonDecoder._v=(Provider.DecodeRecord(CodeSnippet,[["name",Provider.Id(),0],["content",Provider.Id(),0],["parent",WebServer_JsonDecoder.j$1,1],["predecessors",Provider.DecodeList(WebServer_JsonDecoder.j$1),0],["companions",Provider.DecodeList(WebServer_JsonDecoder.j$1),0],["id",WebServer_JsonDecoder.j$1,0],["expanded",Provider.Id(),0]]))();
 };
 WebServer_JsonEncoder.j$2=function()
 {
  return WebServer_JsonEncoder._v$2?WebServer_JsonEncoder._v$2:WebServer_JsonEncoder._v$2=(Provider.EncodeUnion(void 0,"$",[[0,[]],[1,[]],[2,[]],[3,[]]]))();
 };
}());
