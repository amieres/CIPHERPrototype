...
{
 "use strict";
 var CIPHERPrototype,LoginForm,Model,Message,LoginUINext,CodeMirror,EditorRpc,TestFormModule,Button,WebServer,Client,WebServer_Templates,App,App$1,Runtime,List,Result,Wrap,CIPHERHtml,Remoting,AjaxRemotingProvider,Seq,UI,Next,Var,Doc,View,AttrModule,Concurrency,Val,Html,AttrProxy,PrintfHelpers,ListModel;
 ...
 WebServer_Templates.input=function(h)
 {
  ...
  {
   return jQuery.parseHTML("<div class=\"form-group\">\r\n    <label for=\"${Id}\">${Label}</label>\r\n    <input type=\"${Type}\" class=\"form-control\" id=\"${Id}\" ws-var=\"varInput\" placeholder=\"${Label}\">\r\n</div>");
  },h):Doc.PrepareTemplate("mypage",{
   $:1,
   $0:"input"
  },function()
