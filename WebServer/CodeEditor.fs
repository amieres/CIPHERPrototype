...
//"(6) F# let inline storeVar'T storeName (varIRef_) =.fsx"
      [< Inline >]
...
//"(6) F# let codeMirrorIncludes =.fsx"
...
//"(6) F# RunHtmlPlusFree.fsx"
        member        this.RunHtmlPlusFree node =
          ...
          |> this.RunHtml
//"(4) F# module FSharpStation =.fsx"
    [<JavaScript>]
    module FSharpStation =
    
//"(6) F# type CodeSnippetId = CodeSnippetId of System.Guid.fsx"
